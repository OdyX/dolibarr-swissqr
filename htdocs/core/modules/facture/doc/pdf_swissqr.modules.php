...
require_once DOL_DOCUMENT_ROOT.'/core/modules/facture/doc/vendor/autoload.php';
 ...
 */
class pdf_swissqr extends ModelePDFFactures
{
     /**
        ...
        if ($conf->facture->dir_output) {
            ...
            if (file_exists($dir)) {
                ...
                if (! empty($conf->global->INVOICE_ADD_ZATCA_QR_CODE)) {
                    ...
                    // As we're about to display a SwissQR, don't add another one.
                ...
                // Put Swiss QR-invoice on page 1
